...
# ------------------------------------------------------------------
# Assemble piControl pseudo-members r31-r40 into ensemble datasets
#
# This script stacks piControl pseudo-members (r31 to r40) along a new
...
#   /cnrm/ioga/Users/seguy/CMIP6/PiControl/pic_3000
# ------------------------------------------------------------------
...
echo "======================================"
echo "Building piControl ensemble r31-r40"
...
for LAYER in "${LAYERS[@]}"; do
    ...
    case "${LAYER}" in
      tot)
        ...
        OUTFILE="${OUT_DIR}/ohc_2D_pic_3000.nc"
        ;;
      0-300)
        PREFIX_IN="ohc_2D_0-300_pic_yearly"
        OUTFILE="${OUT_DIR}/ohc_2D_pic_3000_0-300.nc"
        ;;
      300-2000)
        PREFIX_IN="ohc_2D_300-2000_pic_yearly"
        OUTFILE="${OUT_DIR}/ohc_2D_pic_3000_300-2000.nc"
        ;;
      2000-bottom)
        PREFIX_IN="ohc_2D_2000-bottom_pic_yearly"
        OUTFILE="${OUT_DIR}/ohc_2D_pic_3000_2000-bottom.nc"
        ;;
    esac
...
echo "======================================"
echo "Done building pic_3000 files"
echo "======================================"
